...
import './Menu.scss'
import Logo from '../../assets/img/Alpha-Centauri-Logo.svg';
            ...
            <nav className="menu__wrapper">
                <div className="logo__wrapper">
                    <a
                        ...
                        className="logo"
                    >
                        <img src={Logo} alt='Alpha Centauri Logo' title='Alpha Centauri Logo' />
                    </a>
                </div>
                <div className={`action-buttons ${width < 768 ? 'hidden' : 'visibility'}`}>
                ...
                <div className={`menu-responsive ${width < 768 ? 'visibility' : 'hidden'}`}>                    
